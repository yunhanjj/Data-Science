...
**Dataset: [economy.csv](https://storage.googleapis.com/covid19-open-data/v3/economy.csv)**
...
**Dataset: [epidemiology.csv](https://storage.googleapis.com/covid19-open-data/v3/epidemiology.csv)**
...
**Dataset: [lawatlas-emergency-declarations.csv](https://storage.googleapis.com/covid19-open-data/v3/lawatlas-emergency-declarations.csv)**

The emergency declarations dataset contains emergency declarations and mitigation policies for each US state starting on
...
[LawAtlas.org][1]. This dataset contains 8364 rows with 104 columns. It is a time-series data frame with dates corresponding to each location, along with boolean variables indicating the whether a state of action is effective.
...
**Dataset: [health.csv](https://storage.googleapis.com/covid19-open-data/v3/health.csv)**
...
**Dataset: [mobility.csv](https://storage.googleapis.com/covid19-open-data/v3/mobility.csv)**
...
**Dataset: [vaccinations.csv](https://storage.googleapis.com/covid19-open-data/v3/vaccinations.csv)**
...
**Dataset: [index.csv](https://storage.googleapis.com/covid19-open-data/v3/index.csv)**
